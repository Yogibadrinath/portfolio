...
const About: React.FC = () => {
  return (
    <section id="about" className="my-5 px-3 px-md-0">
      ...
      <p className="lead">
        Software Developer with 3.4 years of experience in web application development. Skilled in building interactive UIs using React.js, TypeScript, and Node.js for backend services.
      </p>
